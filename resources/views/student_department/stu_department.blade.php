...
@extends('layouts.app')
@section('title', 'Students_Department Page')
@section('content') 
 

 {{-- report --}}
    <div class="report">  
      <h3 class="n-report-z n-studentdep-h">Student Department</h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          ...
                          <table class="table table-hover">
                              <thead>
                              <tr>
                                <th scope="col">No</th><th scope="col">Image</th><th scope="col">Name</th><th scope="col">Age</th><th scope="col">Rank</th><th scope="col">Reg_No</th><th scope="col">Gender</th><th scope="col">Class</th><th scope="col">Subject</th><th>Action</th>
                              </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item h-textdecoration" href="{{route('leaveoutstudent',
                             $student->id)}}">Leave out</a>
                            <a class="dropdown-item h-textdecoration" href="{{route('studentdepdata', $student->id)}}">Personal data</a>
                          </div>
                        </div>
                        <!-- Example single danger button -->
                                </td>
